...
DISCORD_INFRA_ALERT_WEBHOOKS=$(get_settings_value .TWITTERBOT_CREDENTIALS.\"@TournesolBot\".ACCESS_TOKEN_SECRET)
export DISCORD_INFRA_ALERT_WEBHOOKS

DISCORD_TWITTER_WEBHOOKS=$(get_settings_value .TWITTERBOT_CREDENTIALS.\"@TournesolBot\".ACCESS_TOKEN_SECRET)
export DISCORD_TWITTER_WEBHOOKS
