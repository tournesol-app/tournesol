...
class MultiKeyDict:
    def __init__(self, 
        data: Optional[dict[tuple, Any]]=None,
    ...
    def row2key(self, row: Union[dict, Series]) -> dict:
        return { key_name: row[name] for key_name in self.key_names }
