...
class Comparisons(MultiKeyTable):
    ...
    default_keynames: tuple=("username", "criterion", "entity_name", "other_name")
    
    def __init__(self, 
        keynames: list[str] | str | None = None, 
        ...
        *args, **kwargs
        ...
        super().__init__(keynames, init_data, *args, **kwargs)
    ...
    def has_default_type(self) -> bool:
        return type(self) == Comparisons and self.keynames == self.default_keynames
