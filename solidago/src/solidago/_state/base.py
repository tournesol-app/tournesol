...
from ._voting_rights.base import VotingRights
from ._models.direct import ScoringModel, DirectScoring
from ._models.user_models import UserModels
...
class State:
    ...
    def load(cls, directory: Union[Path, str]) -> "State":
        ...
        for key, j_value in j.items():
            ...
            value = getattr(solidago._state, j_value[0]).load(j_value[1])
