...
@pytest.mark.parametrize(
    ...
    [
        ...
        (0.1, np.array([0.1]), np.array([0]), np.array([0.1]), 0.1, -0.0073),
        (0.1, np.array([0.1]), np.array([0]), np.array([0.1]), 0.9, +0.0073),
        (0.1, np.array([1] * 1000), np.array([-1] * 500 + [1] * 500), np.array([0.1] * 1000), 0.10, -1.0712),
        ...
        (1e12, np.array([1000] * 1000), np.arange(1000, 2000, 1), np.array([1e-6] * 1000), 0.90, 1899.3929),
    ]
)
