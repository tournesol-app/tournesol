...
class PrimeFunction(ParallelizedPollFunction):
    ...
    def _variables(self) -> list: # type: ignore
        return list(range(self.base_value, self.base_value + 2 * self.n_values, 2))
    
    def _args(self, variable: int, nonargs) -> list: # type: ignore
        return [variable]
    ...
    def _process_results(self, variables: list, nonargs_list: list, results: list, args_lists: list) -> Poll: # type: ignore
