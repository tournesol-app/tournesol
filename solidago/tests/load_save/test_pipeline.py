...
def test_learned_models(seed):
    ...
    scaled_users, scaled = poll_functions.Mehestan()(users, entities, made_public, base_models)
...
def test_affine_overtrust_test_data(seed):
    ao = poll_functions.AffineOvertrust(privacy_penalty=0.5, min_overtrust=2.0, overtrust_ratio=0.1, max_workers=2)
