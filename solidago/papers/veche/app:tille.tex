...
% \begin{proof}
%     If $e$ and $f$ were posted by the same user $u$,
%     then $b_{ue}, b_{uf} > 0$.
%     If no other user interacted with any, then $b_{ve}, b_{vf} = 0$.
...
%     If $e$ and $f$ were posted by two different users $u$ and $v$,
%     and if no other user interacted with any, 
