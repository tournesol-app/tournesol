...
**videoUnderscoreleft** | [**String**](string.md) |  | [default to null]
**videoUnderscoreright** | [**String**](string.md) |  | [default to null]
**durationUnderscorems** | [**Float**](float.md) | Time from page load to this slider value (in milliseconds) | [optional] [default to null]
**context** | [**ContextEnum**](ContextEnum.md) | The page where slider change occurs | [optional] [default to null]
