...
- criteria:
  The name of the criteria for the comparison. The main criteria is
...
- public_username:
  The public username of the user who has included the video in their
  comparisons
- video:
...
- score:
  ...
  considering all the individual scores on the same video and criteria. With a
