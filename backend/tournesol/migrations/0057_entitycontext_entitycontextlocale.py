        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "origin",
                    models.CharField(
                        choices=[("CONTRIBUTOR", "Contributor"), ("CONTRIBUTOR", "Association")],
                        default="ASSOCIATION",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="A JSON object. They keys/values should match the metadata keys/values of the targeted entities.",
                    ),
                ),
                (
                    "unsafe",
