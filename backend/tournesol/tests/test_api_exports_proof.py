...
class ExportProofOfVote(TestCase):
    ...
    def test_non_staff_cant_get_proof_of_vote(self):
        """
    ...
    def test_staff_can_get_proof_of_vote_empty(self):
        """
        ...
        self.assertEqual(
            csv_lines[0], ["user_id", "username", "email", "n_comparisons", "signature"]
        )

    def test_staff_can_get_proof_of_vote_non_empty(self):
        """
        ...
        self.assertEqual(csv_lines[1][:4], ["3", "non_staff", "non_staff@example.org", "1"])
