...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TournesolApi.VideoRatingsSerializerV2();
  });
  ...
  describe('VideoRatingsSerializerV2', function() {
    it('should create an instance of VideoRatingsSerializerV2', function() {
      // uncomment below and update the code to test VideoRatingsSerializerV2
      //var instane = new TournesolApi.VideoRatingsSerializerV2();
      //expect(instance).to.be.a(TournesolApi.VideoRatingsSerializerV2);
    });
