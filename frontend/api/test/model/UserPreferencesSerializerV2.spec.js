...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TournesolApi.UserPreferencesSerializerV2();
  });
  ...
  describe('UserPreferencesSerializerV2', function() {
    it('should create an instance of UserPreferencesSerializerV2', function() {
      // uncomment below and update the code to test UserPreferencesSerializerV2
      //var instane = new TournesolApi.UserPreferencesSerializerV2();
      //expect(instance).to.be.a(TournesolApi.UserPreferencesSerializerV2);
    });
