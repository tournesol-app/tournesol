...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TournesolApi.Degree();
  });
  ...
  describe('Degree', function() {
    it('should create an instance of Degree', function() {
      // uncomment below and update the code to test Degree
      //var instane = new TournesolApi.Degree();
      //expect(instance).to.be.a(TournesolApi.Degree);
    });
