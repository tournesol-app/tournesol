...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TournesolApi.VideoReportsSerializerV2();
  });
  ...
  describe('VideoReportsSerializerV2', function() {
    it('should create an instance of VideoReportsSerializerV2', function() {
      // uncomment below and update the code to test VideoReportsSerializerV2
      //var instane = new TournesolApi.VideoReportsSerializerV2();
      //expect(instance).to.be.a(TournesolApi.VideoReportsSerializerV2);
    });
