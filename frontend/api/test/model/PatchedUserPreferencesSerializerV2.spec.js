...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TournesolApi.PatchedUserPreferencesSerializerV2();
  });
  ...
  describe('PatchedUserPreferencesSerializerV2', function() {
    it('should create an instance of PatchedUserPreferencesSerializerV2', function() {
      // uncomment below and update the code to test PatchedUserPreferencesSerializerV2
      //var instane = new TournesolApi.PatchedUserPreferencesSerializerV2();
      //expect(instance).to.be.a(TournesolApi.PatchedUserPreferencesSerializerV2);
    });
