...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TournesolApi.PatchedVideoCommentsSerializerV2();
  });
  ...
  describe('PatchedVideoCommentsSerializerV2', function() {
    it('should create an instance of PatchedVideoCommentsSerializerV2', function() {
      // uncomment below and update the code to test PatchedVideoCommentsSerializerV2
      //var instane = new TournesolApi.PatchedVideoCommentsSerializerV2();
      //expect(instance).to.be.a(TournesolApi.PatchedVideoCommentsSerializerV2);
    });
