...
let apiInstance = new TournesolApi.ConstantsApi();
apiInstance.viewConstants((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
[**ConstantsSerializerV2**](ConstantsSerializerV2.md)
