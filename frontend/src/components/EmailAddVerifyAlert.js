    ...
    <>
      {!isCertified && domainRejected && (
        <Alert severity="error" className={`${classes.alertTop} class_rejected`}>
          ...
          <a href="https://wiki.tournesol.app/index.php/51%25_attack" target="_blank">
            51% attack</a>. 
          ...
          <a href="https://wiki.tournesol.app/index.php/Trusted_email_domains" target="_blank">
            trusted email domain</a>
