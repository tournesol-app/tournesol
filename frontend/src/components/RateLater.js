...
export default () => {
  ...
  const sampleTopVideo = () => {
    ...
    api.expertRatingsSamplePopularVideoRetrieve(
      { noRateLater: true },
      (err, data) => {
        if (!err) {
          setTopVideo(data);
  ...
  if (
    requestStatus === null &&
    (videoIdAdd === null || submitStatus === true)
  ) {
  ...
  return (
    <>
      <div className={classes.topVideos} id="id_ratelater_page_all">
        ...
        <br />
        <span>
          Copy-paste the URL of a favorite video of yours to add it to import on
          Tournesol.
          <br />
          ...
          .<br />
          You can also let us load the most viewed videos on our platform.
          <br />
          Our{' '}
      ...
      <Grid container direction="row" justify="center" alignItems="center">
        ...
        {topInRateLater !== true &&
          topVideoId !== null &&
          topVideoId !== undefined &&
          topVideoId !== '' &&
          (videoIdAdd === null || topVideoId !== videoIdAdd) && (
            <Grid item>
              <Button
                size="large"
                variant="contained"
      ...
      >
        ...
        {count !== null && count < minNumRateLater && (
          <Alert severity="info" id="id_recommend_add_more">
            We recommend that you add {minNumRateLater - count} more videos
            before moving to content rating.
          </Alert>
        )}
      </div>
              ...
              <div style={{ flexDirection: 'row' }}>
                {count > 0 && (
                  <div id="id_controls_prev_next">
                    ...
                    &nbsp; Showing videos {offset + 1} to{' '}
                    {Math.min(count, offset + limit + 1)}
                    &nbsp;
                    <Button
