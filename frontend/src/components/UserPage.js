...
export default () => {
  ...
  const needUserInterface =
    data && (window.username === data.username || data.n_public_videos > 0);
  ...
  return (
    <div id="userPage">
      {loading ? (
        <div id="id_user_page_loading" />
      ) : (
        <div id="id_user_page_loaded" />
      )}
      {!loading && data === null && (
        <p>
      ...
      {!loading && data !== null && (
        <>
          ...
          {!loading && !error && data && (
            <>
              <Grid container spacing={3} style={{ paddingBottom: '5px' }}>
                <Grid item xs={9}>
                  <h1>
                    ...
                    {data.is_certified &&
                      data.certified_email_domain !== null && (
                  ...
                  >
                    ...
                    <Grid item>
                      ...
                      {window.username === data.username && (
                        ...
                        >
                          <Tooltip title="Edit my data" aria-label="add">
                            <EditIcon />
                          </Tooltip>
                        </IconButton>
                      )}
      ...
      {needUserInterface === true && (
        <span>
          ...
          <UserInterface
            searchModelOverride={data.username}
            showAllMyVideosInitial="true"
          />
        </span>
      )}
